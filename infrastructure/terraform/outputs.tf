...
output "msk_bootstrap_brokers_tls" {
  ...
  value       = aws_msk_cluster.nexus.bootstrap_brokers_tls
  sensitive   = true
}
...
output "s3_assets_bucket" {
  ...
  value       = aws_s3_bucket.nexus_assets.bucket
}

output "nexus_service_role_arn" {
  description = "IAM role ARN for NEXUS service pods"
  value       = aws_iam_role.nexus_service.arn
}
