  ...
  return (
    <SafeAreaProvider>
      ...
      >
        ...
        <Stack.Screen name="loyalty" options={{ title: 'Sign In for Rewards', headerBackVisible: true }} />
        ...
        <Stack.Screen name="confirmation" options={{ title: 'Order Confirmed', headerBackVisible: false }} />
      </Stack>
    </SafeAreaProvider>
  );
}
