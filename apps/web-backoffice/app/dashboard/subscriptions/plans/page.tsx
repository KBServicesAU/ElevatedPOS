    ...
    return (
      <div className="p-8">
        <div className="animate-pulse space-y-4">
          <div className="h-8 bg-gray-200 dark:bg-gray-700 rounded w-52" />
    ...
    <div className="p-8 max-w-5xl">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-1">Create recurring billing plans for your customers.</p>
        </div>
        {orgId && (
          <button
            type="button"
      ...
      {showCreate && (
        <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl w-full max-w-md p-6">
            <h2 className="text-lg font-bold mb-4 text-gray-900 dark:text-white">Create Subscription Plan</h2>
      ...
      {!orgId ? (
        ...
        <div className="text-center py-20 bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800">
          <div className="text-4xl mb-3">🔄</div>
          <h3 className="font-semibold text-lg mb-1 text-gray-900 dark:text-white">No plans yet</h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {plans.map((plan) => (
            <div
              key={plan.id}
              className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-6 flex flex-col gap-3"
            >
              ...
              <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-3">
                ...
                {plan.trialDays ? (
                  <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5">{plan.trialDays} day free trial</p>
                ) : null}
              </div>
              <div className="flex items-center justify-between mt-auto pt-1">
                <p className="text-xs font-mono text-gray-400 dark:text-gray-500 truncate max-w-[140px]">{plan.id}</p>
                <button
                  type="button"
