...
const releases: AppRelease[] = [
  {
    ...
    downloadUrl: 'https://expo.dev/artifacts/eas/akapmFFsJwLMhb4DiCwydM.apk',
    size: '~45 MB',
  ...
  },
  {
    ...
    downloadUrl: 'https://expo.dev/artifacts/eas/cDEXS84YTNkfDevZzB6dC3.apk',
    size: '~40 MB',
    minAndroid: 'Android 8.0+',
    releasedAt: '2026-04-07',
  ...
  },
  {
    ...
    downloadUrl: 'https://expo.dev/artifacts/eas/kujFYVtQR4cCumRJ4caPqH.apk',
    size: '~42 MB',
    minAndroid: 'Android 8.0+',
    releasedAt: '2026-04-07',
