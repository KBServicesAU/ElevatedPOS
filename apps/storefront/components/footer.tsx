...
export function Footer() {
  return (
    <footer className="relative">
      ...
      <div className="max-w-[1400px] mx-auto px-6 sm:px-8 lg:px-12 pt-16 sm:pt-20 pb-8">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-10 mb-20">
          ...
          <div className="col-span-2">
            ...
            <p className="text-neutral-500 text-sm mt-4 max-w-xs leading-relaxed">
              Cloud-native point of sale built for Australian
          ...
          {Object.entries(footerLinks).map(([group, links]) => (
            <div key={group}>
              <h4 className="text-xs font-medium uppercase tracking-[0.15em] text-neutral-500 mb-4">
                {group}
              </h4>
        ...
        <div className="border-t border-white/[0.06] pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-neutral-600 text-xs">
            &copy; 2026 ElevatedPOS Pty Ltd. All rights reserved.
          </p>
          <div className="flex items-center gap-6">
            <a
              href="https://twitter.com/elevatedpos"
              aria-label="Twitter"
            ...
            <a
              href="https://linkedin.com/company/elevatedpos"
              aria-label="LinkedIn"
              className="text-neutral-600 hover:text-neutral-400 transition-colors duration-300"
            >
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a
              href="https://instagram.com/elevatedpos"
