  ...
  return (
    <div className="flex-1 flex items-start justify-center px-4 py-12">
      <div className="w-full max-w-lg text-center">
        ...
        {orgId && (
          <p className="text-gray-500 text-sm mb-1">Account ID: <span className="font-mono text-gray-700">{orgId}</span></p>
        )}
        ...
        <a
          ...
          className="inline-block bg-indigo-600 hover:bg-indigo-500 text-white font-semibold px-8 py-3.5 rounded-xl transition-colors shadow-md shadow-indigo-200 mb-10"
        >
        ...
        <div className="border-t border-gray-100 pt-8">
          <h2 className="text-sm font-semibold text-gray-500 uppercase tracking-wide mb-4">What to do next</h2>
          <div className="grid grid-cols-1 gap-4 text-left">
            {tips.map((tip) => (
              <div key={tip.title} className="flex items-start gap-4 p-4 rounded-xl border border-gray-100 hover:border-indigo-100 hover:bg-indigo-50 transition-colors cursor-pointer">
                <div className="w-10 h-10 rounded-lg bg-indigo-50 flex items-center justify-center flex-shrink-0">
                  {tip.icon}
                </div>
                <div>
                  <div className="text-sm font-semibold text-gray-900">{tip.title}</div>
                  <div className="text-sm text-gray-500 mt-0.5">{tip.description}</div>
                </div>
